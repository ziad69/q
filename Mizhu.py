...
helpMessage =""" ❂͜͡☆➣Bot By : @ᴢɪᴀᴅ~ｄｅｓυ ≧∀≦
||=====  P U B L I C  =====||
...
❂͜͡☆➣ K on/off
❂͜͡☆➣ Join︎ on/off
❂͜͡☆➣ Gcancel:︎「Number of people」
❂͜͡☆➣ Group cancelalll︎
❂͜͡☆➣ Leave︎ on/off
❂͜͡☆➣ Add on/off
❂͜͡☆➣ Share on/off
❂͜͡☆➣ Message change:「text」
❂͜͡☆➣ Message check
❂͜͡☆➣ Confirm
❂͜͡☆➣ Jam on/off
❂͜͡☆➣ Change clientock:「name」
❂͜͡☆➣ Up
❂͜͡☆➣ Cv join
...
❂͜͡☆➣ Nk 「name」
❂͜͡☆➣ Bye
❂͜͡☆➣ Kill ban 「kill blacklist user」
❂͜͡☆➣ Kill @「Tag」
❂͜͡☆➣ Ban @「Tag」
❂͜͡☆➣ Unban @「Tag」
❂͜͡☆➣ Ban︎ [Share Contact]
❂͜͡☆➣ Unban︎ [Share Contact]
❂͜͡☆➣ Banlist︎
❂͜͡☆➣ Cek ban
❂͜͡☆➣ mid
❂͜͡☆➣ invite:「mid」
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner. https://line.me/p/ti/~anaichiro",
    "lang":"JP",
    "comment":"Owner. https://line.me/p/ti/~anaichiro",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 26:
               ...
               if wait["wblack"] == True:
				...
				if msg.from_ in admin:
					if msg.toType == 2:
						...
						cl.updateGroup(X)
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"Siap Senpai ≧∀≦")
						else:
							cl.sendText(msg.to,"Udah Open Senpai ≧∀≦")
					else:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"Can not be used outside the group")
						else:
            ...
            elif msg.text in ["Curl","Link off","C"]:
				if msg.from_ in admin:
					if msg.toType == 2:
						X = cl.getGroup(msg.to)
						X.preventJoinByTicket = True
						cl.updateGroup(X)
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"Udah Senpai ≧∀≦")
						else:
							cl.sendText(msg.to,"Udah Close Senpai ≧∀≦")
					else:
						if wait["lang"] == "JP":
							cl.sendText(msg.to,"Can not be used outside the group")
						else:
...
#-----------------------------------------------
				elif msg.text in ["Tagall,Summon"]:
					if msg.from_ in admin:
...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Siap Senpai 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
#-----------------------------------------------
...
#-----------------------------------------------
				...
				ki.sendText(msg.to,"Owner : line.me/ti/p/~anaichiro")

#-----------------------------------------------

            elif msg.text in ["hmm"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"Anu")
            elif msg.text in [":v"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"GW GANETENg FIX")
            elif msg.text in ["wkwkwk"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"gak capek senpai ketawa terus? :3")
...
#-----------------------------------------------
				...
				ki.sendText(msg.to,"ALlo 􀜁􀅔Har Har􏿿")
				kk.sendText(msg.to,"ALlo 􀜁􀅔Har Har􏿿")
				kc.sendText(msg.to,"Allo 􀜁􀅔Har Har􏿿")
#-----------------------------------------------
            elif msg.text in ["Responsename","responsename"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"Siap Senpai 􀜁􀅔Har Har􏿿")
#-----------------------------------------------

            elif msg.text in ["Sp","Speed","speed"]:
				if msg.from_ in admin:
					start = time.time()
					cl.sendText(msg.to, "Wait Senpai :3")
...
#------------------------------------------------------------------
				...
				if msg.from_ in admin:
					if msg.toType == 2:
						...
						cl.sendText(msg.to,"LOL 􀜁􀅔Har Har􏿿")
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by https://line.me/p/ti/~anaichiro")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by https://line.me/p/ti/~anaichiro")
						print "Like"
					except:
							pass
				else:
